...
The docker image is based of [Anthropics development containers](https://code.claude.com/docs/en/devcontainer) where the source code can be found [here](https://github.com/anthropics/claude-code/tree/main/.devcontainer)
